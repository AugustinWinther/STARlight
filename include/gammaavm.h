...
class Gammaavectormeson : public eventChannel
{
 ...
 public:
  ...
  bool jpsi4piDecay(starlightConstants::particleTypeEnum& ipid, const double m0, const double px0, const double py0, const double pz0, lorentzVector* decayVecs, int& iFbadevent);
  bool jpsi2kaon2piDecay(starlightConstants::particleTypeEnum& ipid, starlightConstants::particleTypeEnum& ipid2, const double m0, const double px0, const double py0, const double pz0, lorentzVector* decayVecs, int& iFbadevent);
